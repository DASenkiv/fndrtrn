...
export const AboutProject: FC = () => {
    return <div>Сталкивались ли вы с тем, что, гуляя по городу, вы теряли вещь, или забывали её
        где-либо? <br/><br/> Если да, то что делали? Писали в Подслушано своего города? А если вы гуляли не в одном
